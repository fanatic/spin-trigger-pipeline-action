...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    let baseURL, source, no_prometheus = false, version, secret = undefined, httpsAgent = undefined;
    try {
    ...
    try {
        ...
        const response = yield instance.post(`${SPINNAKER_WEBHOOK_URL}/${source}`, requestData);
        ...
        if (response.data.eventProcessed) {
            ...
            core.setFailed('Request sent to Spinnaker using webhook was not processed.');
        }
    }
    catch (error) {
        if (error.response) {
